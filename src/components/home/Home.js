            ...
            <div aria-hidden="true" className="absolute inset-0 grid grid-cols-2 -space-x-52 opacity-40">
                ...
                <div className="relative pt-36 ml-auto">
                    <div className="lg:w-2/3 px-3 text-center mx-auto">
                        <h1 className="text-gray-900  font-bold text-5xl md:text-6xl xl:text-7xl">A new Way to reach your Photos <span className="text-primary">Triptagram.</span></h1>
                    ...
                    <div className="hidden py-8 mt-16 border-y border-gray-100  sm:flex grid grid-cols-3 ">
                            <div className="text-center">
                            <h6 className="text-lg font-semibold text-gray-700 ">Collaborate with me</h6>
                                <p className="mt-2 text-gray-500">Send me money</p>
                            </div>
                            <div className="text-center">
                            <h6 className="text-lg font-semibold text-gray-700 ">12 pictures for free</h6>
                                <p className="mt-2 text-gray-500"> You can Save 12 images  with title and description</p>
                            </div>
                            <div className="text-center">
                            <h6 className="text-lg font-semibold text-gray-700 ">Free Account</h6>
